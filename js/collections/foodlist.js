...
var FoodList = Backbone.Firebase.Collection.extend({
  ...
  // Firebase URL
  // Using firebase to store doesn't make sense for this application
  // particularly when multiple people concurrently access this app
  // but this is used just to show that I can use Firebase APIs.
